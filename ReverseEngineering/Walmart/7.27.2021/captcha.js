...
try {
    ! function () {
        ...
        var J, N, z = (O(T = {}, n("FicrDBEeBg"), (O(C = {}, n("EDYj"), n("IjAoHhdSVFIKIgEA")), O(C, n("FCMkAQEW"), n("Ii4oDBcXUgYwNE0FFRMbLA")), O(C, n("EyESXA"), n("OjcgDApSMRojIQEBHBUXYj8IFQcbACc+TRIXABskJA4FBhsdLGNNNB4XEzEoTRQAFwExbQwKFlIaLSEJRAYaF2IvGBAGHRxiOAMQGx5SNCgfDRQbFyY")), O(C, n("EyESXw"), n("OjcgDApSMRojIQEBHBUXYi4CCQIeFzYoCUhSAh4nLB4BUgUTKzk")), O(C, n("Ey4SXA"), n("JiooHwFSARcnIB5EBh1SIChNBVIRHSwjCAcGGx0sbQQXAQcXbG09CBcTASdtAAUZF1IxOB8BUgsdN2ofAVIdHC4kAwFeUhMsKU0QGhccYj8IAgAXASptGQwXUgIjKgg")), O(C, n("Ey4SXw"), n("JiooHwFSARcnIB5EBh1SIChNBVICAC0vAQEfUgUrOQVECx0HMG0PFh0FASc/Q0QiHhcjPghEBwIVMCwJAVIGHWIhAgUWUiInPwQJFwYXMBVNLAcfEyxtLgwTHh4nIwoB")), C)), O(T, n("ADc"), (O(Q = {}, n("EDYj"), "Нажмите и удерживайте"), O(Q, n("FCMkAQEW"), "Попробуйте еще раз"), O(Q, n("EyESXA"), "Требуется 'Проверка человека'. Пожалуйста, нажмите и удерживайте кнопку до подтверждения"), O(Q, n("EyESXw"), "'Проверка человека' успешна выполнена, пожалуйста, подождите"), O(Q, n("Ey4SXA"), "Похоже, имеется проблема с подключением. Убедитесь, что вы подключены к Интернету, а затем обновите страницу"), O(Q, n("Ey4SXw"), "Кажется, проблема с вашим браузером. Пожалуйста, обновите, чтобы загрузить 'Проверку человека' PerimeterX"), Q)), O(T, n("HC4"), (O(s = {}, n("EDYj"), n("OywqCAAABxk2bQULBxYXLA")), O(s, n("FCMkAQEW"), n("IjAiDwEXAFIqKBlEHQIcKygYEw")), O(s, n("EyESXA"), n("OjcgDApSMRojIQEBHBUXYjsIFhcbATZtGwEAGxQrLgwQGxdcYgUCERZSFidtBgodAlIrIwoBFgAHKTlNEB0GFiM5TRFSFRc0KB8NFBsXJz8JRBAXHDY")), O(s, n("EyESXw"), n("OjcgDApSMRojIQEBHBUXYjsCCAYdHSspQUQXBBcsbQoBFgceJg")), O(s, n("Ey4SXA"), n("NzBtAQ0YGQZiKAgKUgIALS8BARcfUi8oGUQWF1I0KB8GGxwWKyMKRAYXUjgkBwpcUigtPwpEFhMGYjhNCxweGywoTQYXHAZiKANEBBcALCQIEQVSBCc/GwseFRcsPk0AF1ICIyoEChM")), O(s, n("Ey4SXw"), n("NzBtAQ0YGQZiKAgKUgIALS8BARcfUi8oGUQHBVIgPwITARcAYjkIRAgbGCxjTTECFQAjKQhEHR9SEigfDR8XBic/NUQ6Bx8jI00nGhMeLigDAxdSBidtAQUWFxw")), s)), O(T, n("FDA"), (O(a = {}, n("EDYj"), n("MzI9GB0XAFInOU0JExscNigDDQBSFywrAgoRmw")), O(a, n("FCMkAQEW"), n("JCc4BAgeFwhiP4QBAQETOygf")), O(a, n("EyESXA"), n("PidtSiCbFBtiJRgJExscZW0DjREXATEkGQFSBxwnbRuNABsUKy4MEBsdHGxtOwEHGx4uKBdEEwICNzQIFlIXBmIgDA0cBhcsJB9EHhdSICIYEB0cUicjCwscEZtiJxgXAwdVom0OAVIDBydtAQVSBJswJAsNERMGKyIDRAEdGzZtGQEAHxsspAg")), O(a, n("EyESXw"), n("PidtSiCbFBtiJRgJExscZW0MRJsGm2I/CAgXBJtubRsBBxseLigXRAITBisoAxAXAA")), O(a, n("Ey4SXA"), n("Oy5tHgEfEB4nbRREEwQdKz9NERxSAjAiDwiaHxdiLBsBEVIELTkfAVIRHSwjCBwbHRxsbTsBBxseLigXRASbACsrBAEAUgM3KE0SHQcBYqcZAQFSECsoA0QRHRwsKA4Qm1oXa22NRDscBic/AwEGXlIyOAQXUgATJD8MihEaGzE+CB5SHhNiPQwDFw")), O(a, n("Ey4SXw"), n("Oy5tHgEfEB4nbRREEwQdKz9NERxSAjAiDwiaHxdiLBsBEVIELTkfAVIcEzQkCgUGFwcwY00yFwcbLiEIHlIeF2IgCBAGABdirU0KGwQXIzhNFB0HAGIuBQUAFRcwbQEBUlU2qysERBoHHyMkA0NSIhcwJAABBhcAGg")), a)), O(T, n("Fic"), (O(H = {}, n("EDYj"), n("NjCxDg8XHFI3IwlEGhMeNigD")), O(H, n("FCMkAQEW"), n("MCs5GQFSBBcwPhgHGhccYh4EAVIXAWIoHwoXBwZs")), O(H, n("EyESXA"), n("OjcgDApSMRojIQEBHBUXYigfAh0AFic/GUQXGxwnbS8BAQaWNiQKERwVXGIPBBAGF1ImP5EHGRccYjgDAFIaEy45CApSIRsnbQkNF1ImIz4ZAVIQGzFtFxEAUjAnPhmABhsVNyMK")), O(H, n("EyESXw"), n("OjcgDApSMRojIQEBHBUXYiwPAxcBESohAhcBFxxubQ8NBgYXYjoMFgYXHA")), O(H, n("Ey4SXA"), n("NzFtHgcaFxssOU0BGxxSFCgfBhscFjcjChcCAB0gIQgJUggHYioIBhccXGIeGQEeHhcsbT4NF1IBKy4FAQBeUiYsHhdSIRsnbQIKHhscJ20eDRwWXmI4AwBSExk2OAwIGwEbJz8IClIhGydtCQ0XUiEnJBkB")), O(H, n("Ey4SXw"), n("NzFtHgcaFxssOU0BGxxSEj8CBh4XH2IgBBBSOxowKABEMAAdNT4IFlIIB2IqCAYXHFxiDwQQBhdSJLEFFhccUhEkCEQXGxxiGB0DABMWJ20JEQARGm5tGAlSIhcwJAABBhcAGm0lER8THGIOBQUeHhcsKghECAdSLiwJARw")), H)), O(T, n("GCM"), (O(G = {}, n("EDYj"), "長押し"), O(G, n("FCMkAQEW"), "もう一度お試しください"), O(G, n("EyESXA"), "Human Challengeは認証が必要です。認証が終了するまで長押ししてください"), O(G, n("EyESXw"), "Human Challengeが完了しました。お待ちください"), O(G, n("Ey4SXA"), "接続に問題があるようです。オンライン状態であることを確認してからページを更新してください"), O(G, n("Ey4SXw"), "ブラウザに問題があるようです。PerimeterX Human Challengeを読み込めるようにするためにアップグレードしてください"), G)), O(T, n("GS0"), (O(I = {}, n("EDYj"), "누르고 대기하기"), O(I, n("FCMkAQEW"), "다시 시도하세요"), O(I, n("EyESXA"), "Human Challenge는 인증이 필요합니다. 버튼을 누르고 인증될 때까지 기다리세요."), O(I, n("EyESXw"), "Human Challenge가 완료되었습니다, 기다려 주세요."), O(I, n("Ey4SXA"), "연결에 문제가 있는 것 같습니다. 온라인 상태인지 확인하시고, 페이지를 새로고침해 주세요."), O(I, n("Ey4SXw"), "브라우저에 문제가 있는 것 같습니다. PerimeterX Human Challenge를 로드하려면 업그레이드하시기 바랍니다."), I)), O(T, n("AjY"), (O(F = {}, n("EDYj"), n("IjAoHhcbHRwnbQhEIRcVNz8I")), O(F, n("FCMkAQEW"), n("JicjGQFSHB00LAABHAYX")), O(F, n("EyESXA"), n("OjcgDApSMRojIQEBHBUXYj8IFQcXAGI7CBYbFBshLIqHHVxSEiIfRBQTBC0/QUQfExw2KAMME1IdYi8CEJEdUjI/CBcBGx0sLAkLUhMGq20OCx8CHic5DBZSE1I0KB8NFBsRI6qOCw")), O(F, n("EyESXw"), n("OjcgDApSMRojIQEBHBUXYi4CChEeB68pDEhSAh0wbQsFBB0Abm0MAwcTACYo")), O(F, n("Ey4SXA"), n("IiM/CAcXUhojOwgWUgcfYj0fCxAeFy8sTQAXUhEtIwgckR1cYh0CFlIUEzQiH0hSBBcwJAsNAwcXYj4IRBcBBqNtDgscFxE2LAkLUhdSIzkYBR4bCCdtDEQCkxUrIww")), O(F, n("Ey4SXw"), n("IiM/CAcXUhojOwgWUgcfYj0fCxAeFy8sTQcdH1ItbQMFBBcVIykCFlxSIi0/TQITBB0wYU0FBgcTLiQXAVICEzAsTQcTAAAnKgwWUiIXMCQAAQYXABptJREfExxiDgUFHh4XLCoI")), F)), O(T, n("FzE"), (O(u = {}, n("EDYj"), n("IjchHgUAUgtiIAwKBhccJz8")), O(u, n("FCMkAQEW"), n("Oyw5hAoGFx4tbQkBUhwHJzsC")), O(u, n("EyESXA"), n("ICc5AkQaBx8jIwJEABcDNyQIFhdSBCc/BAIbERMhJJ4KXFIiLT9NAhMEHTBhTRQHHgEjbRREHxMcNqQDRBceUiAiGZccUhojPhkFUgMHJ20eAVIEFzAkCw0DBxc")), O(u, n("EyESXw"), n("ICc5AkQaBx8jIwJEER0fMiEIEBMWHWxtPQsAUhQjOwIWXlIXMT0IFhM")), O(u, n("Ey4SXA"), n("IiM/CAcXUgM3KE0MEwtSNyNNFAAdEC4oAAVSER0sbQEFUhEdLCgVDYEcXGIdAhZSFBM0Ih9IUhMBJyqXFhMGF2I8GAFSFwE2rB5EER0cJy4ZBRYdUiNtJAoGFwAsKBlEC15SJigeFAebAW5tDAcGBxMuJBcFUh4TYj2MAxscEw")), O(u, n("Ey4SXw"), n("IiM/CAcXUgM3KE0MEwtSNyNNFAAdEC4oAAVSER0sbRkRUhwTNCgKBRYdAGxtPQsAUhQjOwIWXlITITkYBR4bCCNtHQUAE1IhLB8DEwBSJyFNNhcGHWIlGAkTHB1iKQhEIhcAKyAIEBcAKg")), u)), O(T, n("Gic"), (O(f = {}, n("EDYj"), "לחץ והחזק"), O(f, n("FCMkAQEW"), "אנא נסו שנית"), O(f, n("EyESXA"), "האתגר האנושי דורש אימות. לחץ לחיצה ממושכת על הלחצן עד לאימות"), O(f, n("EyESXw"), "האתגר האנושי הסתיים, המתן בבקשה"), O(f, n("Ey4SXA"), "כנראה שיש בעיה בחיבור לרשת. בבקשה ודא שאתה מחובר, ולאחר מכן תטען את הדף מחדש"), O(f, n("Ey4SXw"), "ככל הנראה יש בעיה בדפדפן, בבקשה עדכן את הדפדפן לגרסה עדכנית כדי לטעון את PerimeterX Human Challenge"), f)), O(T, n("CCpgOTM"), (O(d = {}, n("EDYj"), "按住不放"), O(d, n("FCMkAQEW"), "請再試一次"), O(d, n("EyESXA"), "Human Challenge需要驗證。請按住此按鈕不放直至驗證完成"), O(d, n("EyESXw"), "Human Challenge已完成，請稍候"), O(d, n("Ey4SXA"), "似乎出現了連接問題。請確保您聯機，然後重新整理頁面"), O(d, n("Ey4SXw"), "你的流覽器似乎出現了問題。請升級以載入PerimeterX Human Challenge"), d)), O(T, n("CCpgLio"), (O(S = {}, n("EDYj"), "按住不放"), O(S, n("FCMkAQEW"), "请重试"), O(S, n("EyESXA"), "Human Challenge要求验证。请按住此按钮不放直至验证完成"), O(S, n("EyESXw"), "Human Challenge已完成，请稍候"), O(S, n("Ey4SXA"), "似乎出现了连接问题。请确保你在线，然后刷新页面"), O(S, n("Ey4SXw"), "你的浏览器似乎有问题。请更新以载入PerimeterX Human Challenge"), S)), O(T, n("EzA"), (O(x = {}, n("EDYj"), "اضغط مع الاستمرار"), O(x, n("FCMkAQEW"), "يُرجى المحاولة مرة أخرى"), O(x, n("EyESXA"), "Human Challenge يتطلب التحقق. يرجى الضغط مع الاستمرار على الزر حتى يتم التحقق"), O(x, n("EyESXw"), "Human Challenge اكتمل، يرجى الانتظار"), O(x, n("Ey4SXA"), "يبدو أن هناك مشكلة في الاتصال. يرجى التأكد من أنك متصل، ثم قم بتحديث الصفحة"), O(x, n("Ey4SXw"), "يبدو أن هناك مشكلة في متصفحك. يرجى الترقية لتحميل PerimeterX Human Challenge"), x)), O(T, n("FiM"), (O(y = {}, n("EDYj"), n("JjA0BkQdFVIqIgEA")), O(y, n("FCMkAQEW"), n("IjC1G0QbFRcs")), O(y, n("EyESXA"), n("OjcgDApSMRojIQEBHBUXYiYfggQXAGIvCA8AlBQ2KAEXF1xSFj8UD1ICl2IiCkQaHR4mbQYKEwICJyNBRBscFjYkAUQQFxkwqwsQFwY")), O(y, n("EyESXw"), n("OjcgDApSMRojIQEBHBUXYiuLFhYbFW5tGwEcBlI0KAMIGxUBNg")), O(y, n("Ey4SXA"), n("Nic/TQgTFhcwbRkNHlITNm0bggAXUic5TQsCGR0gIQQKFQECMCIPCBcfXGIGAgoGAB0uIQgWXlITNm0JEVIXAGIiAwgbHBdubQIDUhUXLCIdAgAbASltCQEAFxQ2KB9EARsWJyM")), O(y, n("Ey4SXw"), n("Nic/TQgTFhcwbRkNHlITNm0bggAXUic5TRQAHRAuKABEHxcWYikEClIQAC06HgEAXFINPQoWExYXMG0LCwBSEzZtBAoWHpQxKE00FwAbLygZAQAqUgo4AAUcUjEqLAEIFxwVJw")), y)), O(T, n("Fy4"), (O(p = {}, n("EDYj"), "Πατήστε & Κρατήστε"), O(p, n("FCMkAQEW"), "Παρακαλούμε προσπαθήστε ξανά"), O(p, n("EyESXA"), "Απαιτείται επαλήθευση Δοκιμασίας Ανθρώπου. Παρακαλούμε πατήστε και κρατήστε πατημένο το κουμπί μέχρι να να γίνει η επαλήθευση"), O(p, n("EyESXw"), "Η επαλήθευση Δοκιμασίας Ανθρώπου ολοκληρώθηκε, παρακαλούμε περιμένετε"), O(p, n("Ey4SXA"), "Φαίνεται πως υπάρχει κάποιο πρόβλημα σύνδεσης. Παρακαλούμε βεβαιωθείτε ότι είστε online και στη συνέχεια κάντε ανανέωση της σελίδας"), O(p, n("Ey4SXw"), "Φαίνεται πως υπάρχει πρόβλημα με το πρόγραμμα περιήγησής σας. Παρακαλούμε κάντε αναβάθμιση για να φορτώσετε τη Δοκιμασία Ανθρώπου PerimeterX"), p)), O(T, n("FCM"), (O(M = {}, n("EDYj"), "فشار دهید و نگه دارید"), O(M, n("FCMkAQEW"), "لطفا دوباره تلاش کنید"), O(M, n("EyESXA"), "چالش اثبات انسان بودن را باید کامل کنید. لطفاً دکمه را فشار دهید و نگه دارید تا تائید شود."), O(M, n("EyESXw"), "چالش اثبات انسان بودن کامل شد، لطفاً صبر کنید"), O(M, n("Ey4SXA"), "به نظر مشکل از اتصال شماست. لطفاً مطمئن باشید آنلاین هستید و سپس صفحه را رفرش کنید"), O(M, n("Ey4SXw"), "به نظر مشکل از مرورگر شماست. لطفاً برای بارگذاری چالش انسان بودن PerimeterX، ارتقا دهید"), M)), O(T, n("Gis"), (O(l = {}, n("EDYj"), "दबा कर रखें"), O(l, n("FCMkAQEW"), "कृपया पुनः प्रयास करें"), O(l, n("EyESXA"), "Human Challenge के लिए सत्यापन की जरूरत है। कृपया सत्यापित होने तक बटन दबाए रखें"), O(l, n("EyESXw"), "Human Challenge पूरा हुआ, कृपया प्रतीक्षा करें"), O(l, n("Ey4SXA"), "कनेक्शन का मामला लगता है। कृपया सुनिश्चित करें कि आप ऑनलाइन हैं, और फिर पृष्ठ को रिफ्रेश करें"), O(l, n("Ey4SXw"), "आपके ब्राउज़र में समस्या लगती है। कृपया PerimeterX Human Challenge लोड करने के लिए अपग्रेड करें"), l)), O(T, n("ECw"), (O(X = {}, n("EDYj"), "চেপে ধরে রাখুন"), O(X, n("FCMkAQEW"), "অনুগ্রহ করে পুনরায় চেষ্টা করুন"), O(X, n("EyESXA"), "সত্যিকারের মানুষ কি না সেটি যাচাইকরণ প্রয়োজন। যাচাইকরণ সম্পন্ন না হওয়া পর্যন্ত চেপে ধরে রাখুন"), O(X, n("EyESXw"), "‘সত্যিকারের মানুষ যাচাইকরণ’ সম্পন্ন হয়েছে, অনুগ্রহ করে অপেক্ষা করুন"), O(X, n("Ey4SXA"), "সংযোগে সমস্যা মনে হচ্ছে। নিশ্চিত হোন যে আপনি অনলাইনে আছেন এবং এরপরে পেজটি রিফ্রেশ করুন"), O(X, n("Ey4SXw"), "ব্রাউজারের সমস্যা মনে হচ্ছে। অনুগ্রহ করে ‘PerimeterX সত্যিকারের মানুষ যাচাইকরণ’ লোড করতে আপগ্রেড করুন"), X)), O(T, n("FTc"), (O(j = {}, n("EDYj"), "દબાવો અને પકડી રાખો"), O(j, n("FCMkAQEW"), "કૃપા કરીને ફરીથી પ્રયતન કરો"), O(j, n("EyESXA"), "માનવ પડકારને ચકાસણીની આવશ્યકતા છે. કૃપા કરીને ચકાસણી સુધી બટન દબાવી અને પકડી રાખો"), O(j, n("EyESXw"), "માનવ પડકાર પૂર્ણ થયો, કૃપા કરીને રાહ જુઓ"), O(j, n("Ey4SXA"), "એક જોડાણની બાબત લાગે છે. કૃપા કરીને ખાતરી કરો કે તમે ઓનલાઇન છો અને પછી પૃષ્ઠને તાજું કરો"), O(j, n("Ey4SXw"), "તમારા બ્રાઉઝર સાથે કોઈ સમસ્યા હોય તેમ લાગે છે. કૃપા કરીને પેરીમીટરએક્સ માનવ પડકાર લોડ કરવા માટે કક્ષા ઊંચી કરો"), j)), O(T, n("BiM"), (O(v = {}, n("EDYj"), "அழுத்து & பிடி"), O(v, n("FCMkAQEW"), "தயவுசெய்து மீண்டும் முயற்சிக்கவும்"), O(v, n("EyESXA"), "ஹியூமன் சேலஞ்சிற்கு சரிப்பார்த்தல் தேவைப்படுகிறது. சரிப்பார்த்தல் நிகழும் வரை பட்டனை அழுத்தி சிறிது நேரம் பிடிக்கவும்"), O(v, n("EyESXw"), "ஹியூமன் சேலஞ் முடிந்தது, தயவுசெய்து காத்திருக்கவும்"), O(v, n("Ey4SXA"), "இணைப்பில் சிக்கல் இருப்பதாக தெரிகிறது.. நீங்கள் ஆன்லைனில் இருப்பதை உறுதிச் செய்து கொண்டு பக்கத்தை புதுப்பிக்கவும்"), O(v, n("Ey4SXw"), "உங்கள் ப்ரௌசரில் சிக்கல் இருப்பதாக தெரிகிறது, பெரிமீட்டர்X ஹியூமன் சேலஞ் லோட் ஆவதற்கு ஏதுவாக மேம்படுத்தவும்"), v)), O(T, n("Gjc"), (O(R = {}, n("EDYj"), n("PDsiAA4TUh8nKk2NAVIGIz8ZFxM")), O(R, n("FCMkAQEW"), n("Oas/B5gZXlIyP54Gkx4ZLTcXCxxSiCg/DA")), O(R, n("EyESXA"), "A humán kihívás ellenőrzése szükséges. Nyomja meg és tartsa lenyomva a gombot, amíg meg nem erősíti"), O(R, n("EyESXw"), "Az emberi kihívás befejeződött, kérem várjon"), O(R, n("Ey4SXA"), "Úgy tűnik, hogy kapcsolat van. Kérjük, győződjön meg róla, hogy online van, majd frissítse az oldalt"), O(R, n("Ey4SXw"), "Úgy tűnik, problémát okoz a böngésződben. Kérjük, frissítsd a PerimeterX Human Challenge betöltéséhez"), R)), O(T, n("GyY"), (O(D = {}, n("EDYj"), n("JicmDApSVFIWLAUFHA")), O(D, n("FCMkAQEW"), n("ISshDA8THFIhIg8FUh4TJSQ")), O(D, n("EyESXA"), n("OjcgDApSMRojIQEBHBUXYiAICRAHBjclBgUcUgQnPwQCGxkTMSRDRDoTACM9TRAXGRMsbQkFHFIGIyUMClIGHS8vAghSARMvPQwNUhYbNCgfDRQbGSM+BA")), O(D, n("EyESXw"), n("OjcgDApSMRojIQEBHBUXYj4ICBcBEythTQwTABMybRkRHBUVNw")), O(D, n("Ey4SXA"), n("JiMgHQUZHAsjbQwAE1IfIz4MCBMaUikiAwEZARtsbT0FAQYbKSwDRDMcFiNtHgEWExwlbQIKHhscJ2FNCBMeB2I+CAMTABkjI00IEx8TLA")), O(D, n("Ey4SXw"), n("JiMgHQUZHAsjbQwAE1IfIz4MCBMaUiYoAwMTHFIyKB8FHxATLG0sChYTXGIFDBYTAlI2JAMDGRMGKSwDRAccBjcmTQkXHwcjOU00FwAbLygZAQAqUgo4AAUcUjEqLAEIFxwVJw")), D)), O(T, n("GzY"), (O(Y = {}, n("EDYj"), n("JicjCBYXUgIwKAARBh0")), O(Y, n("FCMkAQEW"), n("IjAiGwVSFhtiIxgLBB0")), O(Y, n("EyESXA"), n("OjcgDApSMRojIQEBHBUXYj8EBxobFyYoTREcE1I0KB8NFBsRI2NNMBsXHCttHRYXHwc2Ik0NHlIGIz4ZC1IUGywiTQVSBBcwJAsNERNSIzsbARwHBiM")), O(Y, n("EyESXw"), n("OjcgDApSMRojIQEBHBUXYqVNFwYTBi1tDgsfAh4nOQwQHVxSAzkZARwWGw")), O(Y, n("Ey4SXA"), n("ISttHgscHVI0KB8NFBsRIzkERBYXG2I9HwsQHhcvJE0AG1IRLSMDAQEBGy0jCEpSMwExJA4RABMGK20JDVIXATEoHwFSHRwuJAMBUhdSIyoKDR0AHCNtAQVSAhMlJAMF")), O(Y, n("Ey4SXw"), n("IStthUQEFwArKwQHEwYdYjgDRAIAHSAhCAkTUhEtI00NHlIGNyJNBgAdBTEoH0pSMxUlJAIWHBMeLW0dAQBSESM/BAcTABdiHQgWGx8XNigfPFI6By8sA0QxGhMuIQgKFRc")), Y)), O(T, n("Ai4"), (O(k = {}, n("EDYj"), "Naciśnij i przytrzymaj"), O(k, n("FCMkAQEW"), "Prosimy spróbować ponownie"), O(k, n("EyESXA"), "Human Challenge wymaga weryfikacji. Naciśnij i przytrzymaj przycisk do momentu uzyskania weryfikacji"), O(k, n("EyESXw"), "Zakończono Human Challenge, prosimy czekać"), O(k, n("Ey4SXA"), "Wystąpił problem z połączeniem. Upewnij się, że jesteś połączony z Internetem, a następnie odśwież stronę"), O(k, n("Ey4SXw"), "Wygląda na to, że wystąpił problem związany z Twoją przeglądarką. Uaktualnij, aby załadować PerimeterX Human Challenge"), k)), O(T, n("AC0"), (O(b = {}, n("EDYj"), "Apăsați lung"), O(b, n("FCMkAQEW"), "Vă rugăm să încercați din nou"), O(b, n("EyESXA"), "Provocarea umană necesită verificare. Apăsați lung butonul până la finalizarea verificării"), O(b, n("EyESXw"), "Provocarea umană a fost finalizată, vă rugăm așteptați"), O(b, n("Ey4SXA"), "Se pare că există o problemă de conectare. Verificați că sunteți online, apoi reîncărcați pagina"), O(b, n("Ey4SXw"), "Se pare că există o problemă legată de browser. Efectuați un upgrade pentru a putea încărca provocarea umană PerimeterX"), b)), O(T, n("Bio"), (O(m = {}, n("EDYj"), "กดค้าง"), O(m, n("FCMkAQEW"), "กรุณาลองอีกครั้ง"), O(m, n("EyESXA"), "Human Challenge จำเป็นต้องทำการยืนยัน โปรดกดปุ่มค้างไว้จนกว่าจะได้รับการยืนยัน"), O(m, n("EyESXw"), "Human Challenge เสร็จสิ้นแล้ว โปรดรอ"), O(m, n("Ey4SXA"), "ดูเหมือนจะเกิดปัญหาในการเชื่อมต่อ โปรดแน่ใจว่าคุณออนไลน์อยู่ และจากนั้นรีเฟรชหน้า"), O(m, n("Ey4SXw"), "ดูเหมือนว่าจะเกิดปัญหากับเบราว์เซอร์ของคุณ โปรดอัปเกรดเพื่อโหลด PerimeterX Human Challenge"), m)), O(T, n("BCtgOyo"), (O(U = {}, n("EDYj"), "Nhấn & Giữ"), O(U, n("FCMkAQEW"), "Vui lòng thử lại"), O(U, n("EyESXA"), "Thử thách Con người yêu cầu xác minh. Vui lòng nhấn và giữ nút này cho đến khi được xác minh"), O(U, n("EyESXw"), "Thử thách Con người đã hoàn thành, vui lòng chờ"), O(U, n("Ey4SXA"), "Dường như đã xảy ra vấn đề về kết nối. Vui lòng đảm bảo bạn đang trực tuyến và sau đó làm mới trang"), O(U, n("Ey4SXw"), "Dường như đã xảy ra vấn đề với trình duyệt của bạn. Vui lòng nâng cấp để tải Thử thách Con người PerimeterX"), U)), T);
        ...
        function FA(A) {
            ...
            if ("undefined" === i("EC0iAQETHA") ? A : ("undefined" == typeof btoa ? "undefined" : aA(btoa)) === i("FDcjDhAbHRw")) return function (A) {
                var i = o;
                // console.log(btoa(encodeURIComponent(A)[i("ACc9AQURFw")](/%([0-9A-F]{2})/g)));
        ...
        var In = 50,
            ...
            xn = function (A, i) {
                ...
                console.log(btoa(c)[n("ACc9AQURFw")](/=/g, n(""))[n("ACc9AQURFw")](/\//g, n("Tw")))
