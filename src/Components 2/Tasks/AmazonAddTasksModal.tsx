...
interface AmazonAddTasksModalProps {
...
const AmazonAddTasksModal : FC<AmazonAddTasksModalProps> = ({
    addTasksEnabled,
    setAddTasksEnabled,
    tasks,
    setTasks,
        ...
        addTasksProfiles.forEach((profile : ProfileObject, i : number) => {
            const newTask : TaskHookProps = {
                taskConfig: {
                    ...
                    site: Site.Amazon, // we know its amazon at this point
...
export default AmazonAddTasksModal;