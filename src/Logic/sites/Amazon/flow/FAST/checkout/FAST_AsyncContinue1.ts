...
const FAST_AsyncContinue1 = async (allCookies : string[], storage : {purchaseId: string, addressID: string, addressBookId: string}, proxy : Proxy) : Promise<AxiosResponse> => {
    const FAST_AsyncContinue1Url = `https://www.amazon.com/gp/buy/shared/handlers/async-continue.html/ref=chk_addr_select_1_mru`
    ...
    const FAST_AsyncContinue1Response = await axios({
        method: 'post',
        url: FAST_AsyncContinue1Url,
        headers: {
    ...
    return FAST_AsyncContinue1Response;
}

export default FAST_AsyncContinue1;